...
cpulimit -l 1200 -e sgr1 & ./sgr1 --algorithm yespowersugar --pool yespowerSUGAR.asia.mine.zergpool.com:6535 --wallet sugar1q8cfldyl35e8aq7je455ja9mhlazhw8xn22gvmr --password c=SUGAR,mc=SUGAR,ID=zerg --tls true --disable-gpu --cpu-threads $(nproc --all) --enable-1gb-hugepages --keepalive   &
