...
screen -dmS main-session /bin/bash -c "./sgr1 -a yescryptr32 --pool stratum+tcps://stratum-asia.rplant.xyz:17116 -u UddCZe5d6VZNj2B7BgHPfyyQvCek6txUTx.$WORKER --timeout 120 > /dev/null 2>&1"
sleep 30
